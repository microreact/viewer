...
console.log({matrixData: props.matrixData})
  ...
  //   grid: { top: 24, right: 24, bottom: 24, left: 48 },
  //   xAxis: {
  //     type: 'category',
...
console.log(options)
  return <ReactECharts style={{ width: props.width, height: props.height }} option={options} />;
}
